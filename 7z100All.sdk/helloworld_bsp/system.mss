...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = eventsGeneratorViaFile
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = eventsGeneratorViaFi_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = eventStreamSwitch
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = eventStreamSwitch_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = eventStreamDuplicate
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = eventStreamDuplicate_0
END
