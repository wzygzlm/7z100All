...
void XEventsgeneratorviafile_Set_counterIn_V(XEventsgeneratorviafile *InstancePtr, u64 Data) {
    ...
    XEventsgeneratorviafile_WriteReg(InstancePtr->Config_BaseAddress, XEVENTSGENERATORVIAFILE_CONFIG_ADDR_COUNTERIN_V_DATA, (u32)(Data));
    XEventsgeneratorviafile_WriteReg(InstancePtr->Config_BaseAddress, XEVENTSGENERATORVIAFILE_CONFIG_ADDR_COUNTERIN_V_DATA + 4, (u32)(Data >> 32));
}
...
u64 XEventsgeneratorviafile_Get_counterIn_V(XEventsgeneratorviafile *InstancePtr) {
    ...
    Data = XEventsgeneratorviafile_ReadReg(InstancePtr->Config_BaseAddress, XEVENTSGENERATORVIAFILE_CONFIG_ADDR_COUNTERIN_V_DATA);
    Data += (u64)XEventsgeneratorviafile_ReadReg(InstancePtr->Config_BaseAddress, XEVENTSGENERATORVIAFILE_CONFIG_ADDR_COUNTERIN_V_DATA + 4) << 32;
    return Data;
}
...
u32 XEventsgeneratorviafile_Get_status_V(XEventsgeneratorviafile *InstancePtr) {
    ...
    Data = XEventsgeneratorviafile_ReadReg(InstancePtr->Config_BaseAddress, XEVENTSGENERATORVIAFILE_CONFIG_ADDR_STATUS_V_DATA);
    return Data;
}
...
u32 XEventsgeneratorviafile_Get_status_V_vld(XEventsgeneratorviafile *InstancePtr) {
    ...
    Data = XEventsgeneratorviafile_ReadReg(InstancePtr->Config_BaseAddress, XEVENTSGENERATORVIAFILE_CONFIG_ADDR_STATUS_V_CTRL);
    return Data & 0x1;
}
