...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net config_data_const_dout [get_bd_pins config_data_const/dout]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net xlcons_data_0x5a5a_dout [get_bd_pins xlcons_data_0x5a5a/dout]
