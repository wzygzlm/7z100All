...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net Net1 [get_bd_pins const_ZERO/dout] [get_bd_pins testAERDVSSM_0/AERSMFifoAlmostFull_AI] [get_bd_pins testAERDVSSM_0/AERSMFifoFull_AI] [get_bd_pins v_axi4s_vid_out_0/fid] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_reset]
  ...
  connect_bd_net -net SPI_Master_With_Sing_0_o_RX_Byte [get_bd_pins SPI_Master_With_Sing_0/o_RX_Byte] [get_bd_pins USBFifoToDVSSPI_0/dvsRXByte_i] [get_bd_pins system_ila_2/probe12]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets SPI_Master_With_Sing_0_o_RX_Byte]
  connect_bd_net -net SPI_Master_With_Sing_0_o_RX_DV [get_bd_pins SPI_Master_With_Sing_0/o_RX_DV] [get_bd_pins USBFifoToDVSSPI_0/dvsRXDataValid_i] [get_bd_pins system_ila_2/probe23]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net bmRequestType_w_do [get_bd_pins system_ila_2/probe40] [get_bd_pins usb_cdc_core_0/bmRequestType_w_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets bmRequestType_w_do]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins USBFifoToDVSSPI_0/dvs_resp_addr_i] [get_bd_pins system_ila_2/probe13] [get_bd_pins usb_cdc_core_0/axi_bram_addr_o]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets c_counter_binary_0_Q]
  connect_bd_net -net c_counter_binary_0_Q1 [get_bd_pins c_counter_binary_0/Q] [get_bd_pins system_ila_2/probe52] [get_bd_pins util_vector_logic_1/Op1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets c_counter_binary_0_Q1]
  ...
  connect_bd_net -net ctrl_ack_r_do [get_bd_pins system_ila_2/probe39] [get_bd_pins usb_cdc_core_0/ctrl_ack_r_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets ctrl_ack_r_do]
  connect_bd_net -net ctrl_sending_r_do [get_bd_pins system_ila_2/probe28] [get_bd_pins usb_cdc_core_0/ctrl_sending_r_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets ctrl_sending_r_do]
  connect_bd_net -net ctrl_stall_r_do [get_bd_pins system_ila_2/probe38] [get_bd_pins usb_cdc_core_0/ctrl_stall_r_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets ctrl_stall_r_do]
  connect_bd_net -net ctrl_txdata_q_do [get_bd_pins system_ila_2/probe33] [get_bd_pins usb_cdc_core_0/ctrl_txdata_q_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets ctrl_txdata_q_do]
  connect_bd_net -net ctrl_txstall_q_do [get_bd_pins system_ila_2/probe37] [get_bd_pins usb_cdc_core_0/ctrl_txstall_q_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets ctrl_txstall_q_do]
  connect_bd_net -net ctrl_txvalid_q_do [get_bd_pins system_ila_2/probe34] [get_bd_pins usb_cdc_core_0/ctrl_txvalid_q_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net outPktReceived_q_do [get_bd_pins USBFifoToDVSSPI_0/outPktReceived_q_do] [get_bd_pins system_ila_2/probe27]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net r_RX_Bit_Count_do [get_bd_pins SPI_Master_With_Sing_0/r_RX_Bit_Count_do] [get_bd_pins system_ila_2/probe24]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets r_RX_Bit_Count_do]
  connect_bd_net -net r_TX_Bit_Count_do [get_bd_pins SPI_Master_With_Sing_0/r_TX_Bit_Count_do] [get_bd_pins system_ila_2/probe26]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets r_TX_Bit_Count_do]
  connect_bd_net -net readAXIBRAM_r_do [get_bd_pins system_ila_2/probe41] [get_bd_pins usb_cdc_core_0/readAXIBRAM_r_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net setup_resp_valid_delay_q_do [get_bd_pins system_ila_2/probe31] [get_bd_pins usb_cdc_core_0/setup_resp_valid_delay_q_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets setup_resp_valid_delay_q_do]
  connect_bd_net -net setup_valid_q_do [get_bd_pins system_ila_2/probe32] [get_bd_pins usb_cdc_core_0/setup_valid_q_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets setup_valid_q_do]
  connect_bd_net -net state_o [get_bd_pins system_ila_2/probe50] [get_bd_pins ulpi_wrapper_0/state_o]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets state_o]
  connect_bd_net -net status_stage_w_do [get_bd_pins system_ila_2/probe42] [get_bd_pins usb_cdc_core_0/status_stage_w_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets status_stage_w_do]
  connect_bd_net -net testAERDVSSM_0_AERSMOutFifoData_DO [get_bd_pins EVMUXDataToXYTSStream_0/eventFIFOIn_V] [get_bd_pins system_ila_0/probe0] [get_bd_pins testAERDVSSM_0/AERSMOutFifoData_DO]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets testAERDVSSM_0_AERSMOutFifoData_DO]
  connect_bd_net -net testAERDVSSM_0_AERSMOutFifoWrite_SO [get_bd_pins EVMUXDataToXYTSStream_0/eventFIFODataValid_V] [get_bd_pins system_ila_0/probe1] [get_bd_pins testAERDVSSM_0/AERSMOutFifoWrite_SO]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net token_valid_w_do [get_bd_pins system_ila_2/probe21] [get_bd_pins usb_cdc_core_0/token_valid_w_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets token_valid_w_do]
  connect_bd_net -net ulpi_clk60_i_0_1 [get_bd_ports ulpi_clk60_i_0] [get_bd_pins SPI_Master_With_Sing_0/i_Clk] [get_bd_pins USBFifoToDVSSPI_0/clk_i] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins system_ila_2/clk] [get_bd_pins ulpi_wrapper_0/ulpi_clk60_i] [get_bd_pins usb_cdc_core_0/clk_i]
  connect_bd_net -net ulpi_data_in_o_d [get_bd_pins system_ila_2/probe36] [get_bd_pins ulpi_wrapper_0/ulpi_data_in_o_d]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets ulpi_data_in_o_d]
  connect_bd_net -net ulpi_data_out_i_d [get_bd_pins system_ila_2/probe35] [get_bd_pins ulpi_wrapper_0/ulpi_data_out_i_d]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets ulpi_data_out_i_d]
  connect_bd_net -net ulpi_dir_i_0_1 [get_bd_ports ulpi_dir_i_0] [get_bd_pins system_ila_2/probe18] [get_bd_pins ulpi_wrapper_0/ulpi_dir_i]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets ulpi_dir_i_0_1]
  connect_bd_net -net ulpi_nxt_i_0_1 [get_bd_ports ulpi_nxt_i_0] [get_bd_pins system_ila_2/probe19] [get_bd_pins ulpi_wrapper_0/ulpi_nxt_i]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets ulpi_nxt_i_0_1]
  connect_bd_net -net ulpi_wrapper_0_ulpi_stp_o [get_bd_ports ulpi_stp_o_0] [get_bd_pins system_ila_2/probe20] [get_bd_pins ulpi_wrapper_0/ulpi_stp_o]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net ulpi_wrapper_0_utmi_rxactive_o [get_bd_pins system_ila_2/probe49] [get_bd_pins ulpi_wrapper_0/utmi_rxactive_o] [get_bd_pins usb_cdc_core_0/utmi_rxactive_i]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net ulpi_wrapper_0_utmi_rxvalid_o [get_bd_pins system_ila_2/probe48] [get_bd_pins ulpi_wrapper_0/utmi_rxvalid_o] [get_bd_pins usb_cdc_core_0/utmi_rxvalid_i]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net usb_cdc_core_0_data_complete_o_do [get_bd_pins USBFifoToDVSSPI_0/dataRecEnd_i] [get_bd_pins system_ila_2/probe16] [get_bd_pins usb_cdc_core_0/data_complete_o_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets usb_cdc_core_0_data_complete_o_do]
  connect_bd_net -net usb_cdc_core_0_ep0_rx_setup_w_do [get_bd_pins USBFifoToDVSSPI_0/setupDataRecStart_i] [get_bd_pins system_ila_2/probe22] [get_bd_pins usb_cdc_core_0/ep0_rx_setup_w_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets usb_cdc_core_0_ep0_rx_setup_w_do]
  connect_bd_net -net usb_cdc_core_0_outport_data_o [get_bd_pins USBFifoToDVSSPI_0/inputData_i] [get_bd_pins system_ila_2/probe14] [get_bd_pins usb_cdc_core_0/outport_data_o]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets usb_cdc_core_0_outport_data_o]
  connect_bd_net -net usb_cdc_core_0_outport_valid_o [get_bd_pins USBFifoToDVSSPI_0/inputDataValid_i] [get_bd_pins system_ila_2/probe15] [get_bd_pins usb_cdc_core_0/outport_valid_o]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets usb_cdc_core_0_outport_valid_o]
  connect_bd_net -net usb_cdc_core_0_rx_out_do [get_bd_pins USBFifoToDVSSPI_0/outDataRecStart_i] [get_bd_pins system_ila_2/probe17] [get_bd_pins usb_cdc_core_0/rx_out_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net usb_reset_w_do [get_bd_pins system_ila_2/probe51] [get_bd_pins usb_cdc_core_0/usb_reset_w_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets usb_reset_w_do]
  connect_bd_net -net usbf_ep_data_bit_r_do [get_bd_pins system_ila_2/probe44] [get_bd_pins usb_cdc_core_0/usbf_ep_data_bit_r_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets usbf_ep_data_bit_r_do]
  connect_bd_net -net usbf_new_data_bit_r_do [get_bd_pins system_ila_2/probe47] [get_bd_pins usb_cdc_core_0/usbf_new_data_bit_r_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets usbf_new_data_bit_r_do]
  connect_bd_net -net usbf_state_q_do [get_bd_pins system_ila_2/probe46] [get_bd_pins usb_cdc_core_0/usbf_state_q_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets usbf_state_q_do]
  connect_bd_net -net usbf_tx_pid_q_do [get_bd_pins system_ila_2/probe43] [get_bd_pins usb_cdc_core_0/usbf_tx_pid_q_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets usbf_tx_pid_q_do]
  connect_bd_net -net usbf_tx_valid_q_do [get_bd_pins system_ila_2/probe45] [get_bd_pins usb_cdc_core_0/usbf_tx_valid_q_do]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins usb_cdc_core_0/inport_valid_i] [get_bd_pins util_vector_logic_1/Res]
  ...
  connect_bd_net -net w_Master_Ready_do [get_bd_pins SPI_Master_With_Sing_0/w_Master_Ready_do] [get_bd_pins system_ila_2/probe25]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets w_Master_Ready_do]
  connect_bd_net -net wrOUTIndex_q_do [get_bd_pins USBFifoToDVSSPI_0/wrOUTIndex_q_do] [get_bd_pins system_ila_2/probe30]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets wrOUTIndex_q_do]
  connect_bd_net -net wrSetupIndex_q_do [get_bd_pins USBFifoToDVSSPI_0/wrSetupIndex_q_do] [get_bd_pins system_ila_2/probe29]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net xlslice_4_Dout [get_bd_pins usb_cdc_core_0/inport_data_i] [get_bd_pins xlslice_4/Dout]
