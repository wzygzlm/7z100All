...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net xlslice_4_Dout [get_bd_pins eventStreamSwitch_0/select_V] [get_bd_pins system_ila_0/probe42] [get_bd_pins xlslice_4/Dout]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
