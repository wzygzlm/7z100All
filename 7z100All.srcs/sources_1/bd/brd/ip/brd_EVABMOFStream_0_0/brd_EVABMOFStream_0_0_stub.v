...
// Command     : write_verilog -force -mode synth_stub -rename_top brd_EVABMOFStream_0_0 -prefix
//               brd_EVABMOFStream_0_0_ brd_EVABMOFStream_0_0_stub.v
...
(* x_core_info = "EVABMOFStream,Vivado 2018.1" *)
module brd_EVABMOFStream_0_0(status_V_ap_vld, xStreamIn_V_V_TVALID, 
...
/* synthesis syn_black_box black_box_pad_pin="status_V_ap_vld,xStreamIn_V_V_TVALID,xStreamIn_V_V_TREADY,xStreamIn_V_V_TDATA[15:0],yStreamIn_V_V_TVALID,yStreamIn_V_V_TREADY,yStreamIn_V_V_TDATA[15:0],tsStreamIn_V_V_TVALID,tsStreamIn_V_V_TREADY,tsStreamIn_V_V_TDATA[63:0],polStreamIn_V_V_TVALID,polStreamIn_V_V_TREADY,polStreamIn_V_V_TDATA[7:0],xStreamOut_V_V_TVALID,xStreamOut_V_V_TREADY,xStreamOut_V_V_TDATA[15:0],yStreamOut_V_V_TVALID,yStreamOut_V_V_TREADY,yStreamOut_V_V_TDATA[15:0],tsStreamOut_V_V_TVALID,tsStreamOut_V_V_TREADY,tsStreamOut_V_V_TDATA[63:0],polStreamOut_V_V_TVALID,polStreamOut_V_V_TREADY,polStreamOut_V_V_TDATA[7:0],pixelDataStream_V_V_TVALID,pixelDataStream_V_V_TREADY,pixelDataStream_V_V_TDATA[15:0],config_V[31:0],status_V[31:0],ap_clk,ap_rst_n,ap_done,ap_start,ap_ready,ap_idle" */;
  ...
  output [15:0]pixelDataStream_V_V_TDATA;
  input [31:0]config_V;
  output [31:0]status_V;
  input ap_clk;
  input ap_rst_n;
  output ap_done;
  input ap_start;
