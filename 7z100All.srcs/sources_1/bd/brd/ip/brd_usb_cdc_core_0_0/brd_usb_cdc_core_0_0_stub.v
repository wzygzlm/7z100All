...
module brd_usb_cdc_core_0_0(clk_i, rst_i, enable_i, utmi_data_in_i, 
  ...
  status_stage_w_do, vendorReqRecived_o, axi_bram_addr_o, axi_bram_w_data_o, 
  axi_bram_r_data_i, utmi_data_out_o, utmi_txvalid_o, utmi_op_mode_o, utmi_xcvrselect_o, 
  utmi_termselect_o, utmi_dppulldown_o, utmi_dmpulldown_o, inport_accept_o, 
