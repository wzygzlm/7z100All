...
proc create_root_design { parentCell } {
  ...
  set probe63 [ create_bd_port -dir I -from 7 -to 0 probe63 ]
  ...
  set probe67 [ create_bd_port -dir I -from 2 -to 0 probe67 ]
  set probe68 [ create_bd_port -dir I -from 0 -to 0 probe68 ]
  set probe69 [ create_bd_port -dir I -from 7 -to 0 probe69 ]
