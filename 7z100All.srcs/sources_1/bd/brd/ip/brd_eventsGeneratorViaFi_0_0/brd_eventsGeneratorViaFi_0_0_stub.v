...
module brd_eventsGeneratorViaFi_0_0(counterOut_V_ap_vld, s_axi_config_AWADDR, 
  ...
  ap_rst_n, ap_start, ap_done, ap_idle, ap_ready, counterOut_V, xStreamOut_V_V_TVALID, 
  ...
  polStreamOut_V_V_TREADY, polStreamOut_V_V_TDATA)
/* synthesis syn_black_box black_box_pad_pin="counterOut_V_ap_vld,s_axi_config_AWADDR[5:0],s_axi_config_AWVALID,s_axi_config_AWREADY,s_axi_config_WDATA[31:0],s_axi_config_WSTRB[3:0],s_axi_config_WVALID,s_axi_config_WREADY,s_axi_config_BRESP[1:0],s_axi_config_BVALID,s_axi_config_BREADY,s_axi_config_ARADDR[5:0],s_axi_config_ARVALID,s_axi_config_ARREADY,s_axi_config_RDATA[31:0],s_axi_config_RRESP[1:0],s_axi_config_RVALID,s_axi_config_RREADY,ap_clk,ap_rst_n,ap_start,ap_done,ap_idle,ap_ready,counterOut_V[63:0],xStreamOut_V_V_TVALID,xStreamOut_V_V_TREADY,xStreamOut_V_V_TDATA[15:0],yStreamOut_V_V_TVALID,yStreamOut_V_V_TREADY,yStreamOut_V_V_TDATA[15:0],tsStreamOut_V_V_TVALID,tsStreamOut_V_V_TREADY,tsStreamOut_V_V_TDATA[63:0],polStreamOut_V_V_TVALID,polStreamOut_V_V_TREADY,polStreamOut_V_V_TDATA[7:0]" */;
