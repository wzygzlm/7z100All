...
-- Command     : write_vhdl -force -mode funcsim -rename_top brd_EFAST_output_0_0 -prefix
--               brd_EFAST_output_0_0_ brd_EFAST_output_0_1_sim_netlist.vhdl
...
entity brd_EFAST_output_0_0_EFAST_output is
  port (
    ap_clk : in STD_LOGIC;
...
end brd_EFAST_output_0_0_EFAST_output;

architecture STRUCTURE of brd_EFAST_output_0_0_EFAST_output is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity brd_EFAST_output_0_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
    ap_start : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of brd_EFAST_output_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of brd_EFAST_output_0_0 : entity is "brd_EFAST_output_0_1,EFAST_output,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of brd_EFAST_output_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of brd_EFAST_output_0_0 : entity is "EFAST_output,Vivado 2018.1";
end brd_EFAST_output_0_0;

architecture STRUCTURE of brd_EFAST_output_0_0 is
...
begin
U0: entity work.brd_EFAST_output_0_0_EFAST_output
     port map (
      ap_clk => ap_clk,
      ap_done => ap_done,
      ap_idle => ap_idle,
